...
Ruft dieselben Service-Funktionen wie /wissen, /themen und /recherche auf
(services/preparation.py) statt eltern.py's Router-Funktionen direkt
anzusprechen — eine fachliche Entscheidung soll nur an einer Stelle im Code
stehen (Abschnitt 28, "Ein Prozess - eine Wahrheit"; change.txt Aufgabe 2).
Die alten Adressen bleiben erreichbar, bis sie in einer spaeteren Phase
abgebaut werden (Abschnitt 17/24, Phase 6).
"""
